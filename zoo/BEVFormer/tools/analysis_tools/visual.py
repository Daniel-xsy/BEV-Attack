...
if __name__ == '__main__':
    nusc = NuScenes(version='v1.0-mini', dataroot='/data1/shaoyuan/nuscenes', verbose=True)
    # render_annotation('7603b030b42a4b1caa8c443ccc1a7d52')
    bevformer_results = mmcv.load('/home/cixie/shaoyuan/BEV-Attack/test/bevformer_base/debug/pts_bbox/results_nusc.json')
