...
def main():
    trainval_nusc = NuScenes(version='v1.0-mini',
                             dataroot='/data1/data/shaoyuan/nuscenes_mini',
                             verbose=True)
    train_scenes = splits.train
    val_scenes = splits.val
    train_infos = generate_info(trainval_nusc, train_scenes)
    val_infos = generate_info(trainval_nusc, val_scenes)
    mmcv.dump(train_infos, '/data1/data/shaoyuan/nuscenes_mini/nuscenes_infos_train.pkl')
    mmcv.dump(val_infos, '/data1/data/shaoyuan/nuscenes_mini/nuscenes_infos_val.pkl')
    # test_nusc = NuScenes(version='v1.0-test',
    #                      dataroot='/data1/shaoyuan/nuscenes',
    #                      verbose=True)
