...
key2loss = {
    "cls_loss_od": cls_loss_od,
    "bbox_loss_od": bbox_loss_od,
    ...
    "smooth_L1_loss_gamma": smooth_L1_loss_gamma
}
...
def _init_adv_loss(loss_name, arg):
    ...
    elif loss_name in ("smooth_L1_loss"):
        return key2loss[loss_name]
    elif loss_name in ("multi_scale_patch_composition","multi_scale_patch_composition_targeted", "smooth_L1_loss_gamma") and arg is not None:
