_base_ = [
    ...
    '/home/cixie/shaoyuan/mmdetection3d/configs/_base_/schedules/cyclic_20e.py', 
...
data = dict(
    ...
    val=dict(ann_file=data_root + 'nuscenes_infos_temporal_val.pkl',
             pipeline=test_pipeline, 
             classes=class_names, 
             modality=input_modality),
    test=dict(ann_file=data_root + 'nuscenes_infos_temporal_val.pkl',
              pipeline=test_pipeline, 
              classes=class_names, 
              modality=input_modality))
