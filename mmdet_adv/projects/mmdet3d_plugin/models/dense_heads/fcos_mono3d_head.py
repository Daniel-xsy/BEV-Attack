...
from projects.mmdet3d_plugin.core.post_processing.box3d_nms import custom_box3d_multiclass_nms
...
from projects.mmdet3d_plugin.core.bbox import points_img2cam

INF = 1e8


@HEADS.register_module()
class CustomFCOSMono3DHead(AnchorFreeMono3DHead):
    ...
    def _get_bboxes_single(self,
        ...
        results = custom_box3d_multiclass_nms(mlvl_bboxes, mlvl_bboxes_for_nms,
                                       mlvl_nms_scores, cfg.score_thr,
                                       cfg.max_per_img, cfg, mlvl_dir_scores,
                                       mlvl_attr_scores)
        bboxes, scores, labels, logits, dir_scores, attrs = results
        ...
        return bboxes, scores, labels, logits, attrs
