...
def custom_box3d_multiclass_nms(mlvl_bboxes,
                         mlvl_bboxes_for_nms,
                         mlvl_scores,
                         score_thr,
                         max_num,
    ...
    for i in range(0, num_classes):
        ...
        logits.append(_logits[selected])
    ...
    if bboxes:
        ...
        logits = mlvl_scores.new_zeros((0, ))
        if mlvl_dir_scores is not None:
    ...
    results = (bboxes, scores, labels, logits)
