...
from projects.mmdet3d_plugin.core import custom_bbox3d2result
...
class Petr3D_Adv(MVXTwoStageDetector):
    """Petr3D."""
    ...
    def __init__(self,
                 ...
                 test_cfg=None,
                 pretrained=None):
        super(Petr3D_Adv, self).__init__(pts_voxel_layer, pts_voxel_encoder,
