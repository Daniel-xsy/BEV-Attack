Load model checkpoint from ../models/pgd/pgd_r101_caffe_fpn_gn-head_2x16_2x_nus-mono3d_finetune_20211114_162135-5ec7c1cd.pth
## Model Configuration
...
attack = dict(
    ...
    max_train_samples=18000,
    patch_path=
    '/home/cixie/shaoyuan/BEV-Attack/mmdet_adv/uni_patch/size200_scale0.3_sample18000_PGDMono3D.pkl',
    scale=[0.3],
    patch_size=(200, 200),
    img_norm=dict(
        mean=[103.53, 116.28, 123.675], std=[1.0, 1.0, 1.0], to_rgb=False),
...
| ------- | ------- | -------- | -------- | -------- | -------- | -------- |
| 0.1797    | 0.0955    | 0.9082     | 0.5165     | 0.8215     | 1.3730     | 0.4340     |
...
| **NDS** | **mAP** | **mATE** | **mASE** | **mAOE** | **mAVE** | **mAAE** |
| ------- | ------- | -------- | -------- | -------- | -------- | -------- |
| 0.2222    | 0.1683    | 0.8644     | 0.5061     | 0.8506     | 1.4020     | 0.3988     |Load model checkpoint from ../models/pgd/pgd_r101_caffe_fpn_gn-head_2x16_2x_nus-mono3d_finetune_20211114_162135-5ec7c1cd.pth
## Model Configuration
...
| **NDS** | **mAP** | **mATE** | **mASE** | **mAOE** | **mAVE** | **mAAE** |
| ------- | ------- | -------- | -------- | -------- | -------- | -------- |
| 0.1785    | 0.1053    | 0.8996     | 0.5185     | 0.8873     | 1.3691     | 0.4368     |
Load model checkpoint from ../models/pgd/pgd_r101_caffe_fpn_gn-head_2x16_2x_nus-mono3d_finetune_20211114_162135-5ec7c1cd.pth
## Model Configuration
...
| **NDS** | **mAP** | **mATE** | **mASE** | **mAOE** | **mAVE** | **mAAE** |
| ------- | ------- | -------- | -------- | -------- | -------- | -------- |
| 0.1901    | 0.1141    | 0.8713     | 0.5132     | 0.8408     | 1.3939     | 0.4445     |
...
| **NDS** | **mAP** | **mATE** | **mASE** | **mAOE** | **mAVE** | **mAAE** |
| ------- | ------- | -------- | -------- | -------- | -------- | -------- |
| 0.2227    | 0.1484    | 0.8284     | 0.5127     | 0.7940     | 1.2884     | 0.3796     |
...
| **NDS** | **mAP** | **mATE** | **mASE** | **mAOE** | **mAVE** | **mAAE** |
| ------- | ------- | -------- | -------- | -------- | -------- | -------- |
| 0.2763    | 0.2308    | 0.8131     | 0.4866     | 0.7529     | 1.2815     | 0.3390     |
...
| **NDS** | **mAP** | **mATE** | **mASE** | **mAOE** | **mAVE** | **mAAE** |
| ------- | ------- | -------- | -------- | -------- | -------- | -------- |
| 0.2631    | 0.2183    | 0.8294     | 0.4918     | 0.7915     | 1.2769     | 0.3482     |
...
| **NDS** | **mAP** | **mATE** | **mASE** | **mAOE** | **mAVE** | **mAAE** |
| ------- | ------- | -------- | -------- | -------- | -------- | -------- |
| 0.3007    | 0.2575    | 0.7889     | 0.4729     | 0.6930     | 1.3266     | 0.3256     |
...
| **NDS** | **mAP** | **mATE** | **mASE** | **mAOE** | **mAVE** | **mAAE** |
| ------- | ------- | -------- | -------- | -------- | -------- | -------- |
| 0.1670    | 0.0879    | 0.9160     | 0.5161     | 0.8889     | 1.4220     | 0.4481     |
...
| **NDS** | **mAP** | **mATE** | **mASE** | **mAOE** | **mAVE** | **mAAE** |
| ------- | ------- | -------- | -------- | -------- | -------- | -------- |
| 0.1669    | 0.0893    | 0.8946     | 0.5202     | 0.8804     | 1.3875     | 0.4820     |
...
| **NDS** | **mAP** | **mATE** | **mASE** | **mAOE** | **mAVE** | **mAAE** |
| ------- | ------- | -------- | -------- | -------- | -------- | -------- |
| 0.2074    | 0.1414    | 0.8511     | 0.5202     | 0.8620     | 1.2802     | 0.3997     |
...
| **NDS** | **mAP** | **mATE** | **mASE** | **mAOE** | **mAVE** | **mAAE** |
| ------- | ------- | -------- | -------- | -------- | -------- | -------- |
| 0.2836    | 0.2391    | 0.8003     | 0.4840     | 0.7046     | 1.3514     | 0.3709     |
...
| **NDS** | **mAP** | **mATE** | **mASE** | **mAOE** | **mAVE** | **mAAE** |
| ------- | ------- | -------- | -------- | -------- | -------- | -------- |
| 0.2651    | 0.2178    | 0.8425     | 0.4881     | 0.7562     | 1.2450     | 0.3517     |
...
| **NDS** | **mAP** | **mATE** | **mASE** | **mAOE** | **mAVE** | **mAAE** |
| ------- | ------- | -------- | -------- | -------- | -------- | -------- |
| 0.2919    | 0.2546    | 0.7845     | 0.4729     | 0.7593     | 1.3260     | 0.3372     |
...
| **NDS** | **mAP** | **mATE** | **mASE** | **mAOE** | **mAVE** | **mAAE** |
| ------- | ------- | -------- | -------- | -------- | -------- | -------- |
| 0.2750    | 0.2445    | 0.8250     | 0.4780     | 0.8156     | 1.3421     | 0.3542     |
...
| **NDS** | **mAP** | **mATE** | **mASE** | **mAOE** | **mAVE** | **mAAE** |
| ------- | ------- | -------- | -------- | -------- | -------- | -------- |
| 0.2887    | 0.2513    | 0.8009     | 0.4754     | 0.7540     | 1.3453     | 0.3386     |
